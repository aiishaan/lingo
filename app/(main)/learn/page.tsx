...
const LearnPage = async () => {
  ...
  const userProgresPromise = getUserProgress()
  ...
  const [userProgress, units, courseProgress, lessonPercentage, userSubscription] = await Promise.all([userProgresPromise, unitsData, courseProgressPromise, lessonPercentagePromise, userSubscriptionData])
